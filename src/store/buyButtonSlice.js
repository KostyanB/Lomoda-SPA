...
const { initDisableBuyButton, buyButtonChecker, initBuyButtonText } =
...
export const buyButtonSlice = createSlice({
  ...
  reducers: {
    ...
    toggleBtnText: state => {
      const newText =
        state.buyButtonText === "Добавить в корзину"
          ? "Удалить из корзины"
          : "Добавить в корзину";
...
export const { checkDisableBuy, setColorInit, setSizeInit, toggleBtnText } =
